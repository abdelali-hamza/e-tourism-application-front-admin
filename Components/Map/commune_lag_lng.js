...
export const findLocation = (wilaya) => {
	return findWilaya(wilaya);
};

const findWilaya = (wilaya) => {
	for (var i = 0; i < 58; i++) {
		if (wilayas_lat_lng[i].name === wilaya) {
			return {
				lat: wilayas_lat_lng[i].longitude,
				lng: wilayas_lat_lng[i].latitude,
			};
		}
	}
	return null;
